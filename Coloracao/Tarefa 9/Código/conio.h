...
void clreol(void) { printf("\033[K"); }

void gotoxy(int x, int y) { printf("\033[%d;%df", y, x); }

void clrscr(void) { printf("\033[%dm\033[2J\033[1;1f", background_color); }

void textbackground(int color) { background_color = (color % 16) + 40; }
...
int getch(void) { return setEchoMode(false); }

int getche(void) { return setEchoMode(true); }
...
int putchar(int c) { return putch(c); }
